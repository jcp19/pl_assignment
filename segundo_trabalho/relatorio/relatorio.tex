...
este será imediatamente imprimido no ecrã. Caso seja detetada a definição de uma função com recurso ao \textit{template}, o código da função 
...
o conteúdo dos buffers é formatado de forma a obedecer à sintaxe da linguagem \textit{C} e a completar definição da função, culminando numa função
\textit{C} bem formada. Depois disto, a função obtida é apresentada no ecrã.
...
definição de uma função através do uso do \textit{template}. Nesse caso, 
