...
porque o ganho obtido por fazer uma função completa seria mínimo face à versão atual e consistiria apenas em fazer "mais do mesmo".
\subsection{Codificação e Testes}
\subsubsection{Alternativas, Decisões e Problemas de Implementação}
\subsubsection{Testes realizados e Resultados}
Mostram-se a seguir alguns testes feitos (valores introduzidos) e
os respectivos resultados obtidos:
